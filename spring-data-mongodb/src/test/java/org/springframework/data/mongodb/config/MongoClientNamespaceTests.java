...
public class MongoClientNamespaceTests {
	...
	public void clientWithClusterSettings() {
		...
		MongoClientClientFactoryBean factoryBean = ctx.getBean("&client-with-cluster-settings",
				MongoClientClientFactoryBean.class);
	...
	public void clientWithConnectionPoolSettings() {
		...
		MongoClientClientFactoryBean factoryBean = ctx.getBean("&client-with-connection-pool-settings",
				MongoClientClientFactoryBean.class);
		...
		assertThat(settings.getConnectionPoolSettings().getMaxWaitQueueSize()).isEqualTo(5);
