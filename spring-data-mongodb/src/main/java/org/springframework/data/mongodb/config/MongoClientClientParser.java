...
/**
 * Parser for {@code mongo.mongo-client} definitions.
 *
 * @author Christoph Strobl
 * @since 2.3
 */
public class MongoClientClientParser implements BeanDefinitionParser {
	...
	public BeanDefinition parse(Element element, ParserContext parserContext) {
		...
		BeanDefinitionBuilder builder = BeanDefinitionBuilder.genericBeanDefinition(MongoClientClientFactoryBean.class);

		ParsingUtils.setPropertyValue(builder, element, "port", "port");
		ParsingUtils.setPropertyValue(builder, element, "host", "host");
		ParsingUtils.setPropertyValue(builder, element, "credential", "credential");
		ParsingUtils.setPropertyValue(builder, element, "replicaSet", "replicaSet");
		ParsingUtils.setPropertyValue(builder, element, "connectionString", "connectionString");
